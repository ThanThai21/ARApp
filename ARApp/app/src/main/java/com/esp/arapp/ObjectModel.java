...
public class ObjectModel {
    ...
    public static ObjectModel loadFromStream(InputStream is, String texture_name) throws IOException
    {
        ObjectModel obj = ObjLoader.loadFromStream(is);
    ...
    private static class ObjLoader
    {
        ...
        public static ObjectModel loadFromStream(InputStream is) throws IOException
        {
